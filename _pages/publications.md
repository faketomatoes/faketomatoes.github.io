...
4. **[Asymptotic Time-Uniform Inference for Parameters in Averaged Stochastic Approximation](https://arxiv.org/pdf/2410.15057)**  
   Chuhan Xie, Kaicheng Jin, **Jiadong Liang**, and Zhihua Zhang

5. **[Estimation and Inference in Distributional Reinforcement Learning](https://projecteuclid.org/journals/annals-of-statistics/volume-53/issue-5/Estimation-and-inference-in-distributional-reinforcement-learning/10.1214/25-AOS2527.short)**  
    Liangyu Zhang, Yang Peng, **Jiadong Liang**, Wenhao Yang, and Zhihua Zhang  
    *Annals of Statistics* (2025)
   
6. **[Gradient Tracking for High Dimensional Federated Optimization](https://arxiv.org/pdf/2312.05590.pdf)**  
   **Jiadong Liang**<sup>&#42;</sup>, Yang Peng<sup>&#42;</sup>, and Zhihua Zhang<sup>&#42;</sup>

7. **[Stochastic Approximation MCMC, Online Inference, and Applications in Optimization of Queueing Systems](https://arxiv.org/pdf/2309.09545.pdf)**  
   Xiang Li<sup>&#42;</sup>, **Jiadong Liang**<sup>&#42;</sup>, Xinyun Chen, and Zhihua Zhang  
   *Operations Research* (2026)

8. **[A statistical analysis of Polyak-Ruppert averaged Q-learning](https://proceedings.mlr.press/v206/li23b/li23b.pdf)**  
...
9. **[Online statistical inference for nonlinear stochastic approximation with Markovian data](https://arxiv.org/pdf/2302.07690.pdf)**  
   Xiang Li, **Jiadong Liang**, and Zhihua Zhang

10. **[Asymptotic behaviors of projected stochastic approximation: a jump diffusion perspective](https://proceedings.neurips.cc/paper_files/paper/2022/file/dfdc9c54cd62f2b2bfd8b090b3489b7f-Paper-Conference.pdf)**  
...
11. **[Statistical estimation and inference via local sgd](https://proceedings.mlr.press/v178/li22b/li22b.pdf)**  
   Xiang Li, **Jiadong Liang**, Xiangyu Chang, and Zhihua Zhang  
   *Conference on Learning Theory (COLT)* (2022)

12. **[Intervention generative adversarial networks](https://arxiv.org/pdf/2008.03712.pdf)**  
   **Jiadong Liang**, Liangyu Zhang, Cheng Zhang, and Zhihua Zhang  

13. **[Lipschitz generative adversarial nets](http://proceedings.mlr.press/v97/zhou19c/zhou19c.pdf)**  
